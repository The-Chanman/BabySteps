...
//  Swift Classes
  ...
  var user1 = UserClass.init(firstName: "Eric", age: 27)
  user1.lastName = "Chanman"
...
//  Swift Structs
  ...
  let level2 = GameLevel(levelID: 2, levelDescription: "Level 1", isCurrentLevel: true)
//  level2.isCurrentLevel=false  This doesn't work because the struct has been declared as a let 
